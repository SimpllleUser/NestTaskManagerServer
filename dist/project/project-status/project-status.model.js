...
let ProjectStatus = class ProjectStatus extends sequelize_typescript_1.Model {
};
__decorate([
...
__decorate([
    ...
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, unique: true, allowNull: false }),
    __metadata("design:type", Number)
], ProjectStatus.prototype, "value", void 0);
ProjectStatus = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'project_status' })
], ProjectStatus);
