...
TaskCommentModule = __decorate([
    (0, common_1.Module)({
        providers: [task_comment_service_1.TaskCommentService],
        imports: [sequelize_1.SequelizeModule.forFeature([task_model_1.Task, task_comment_model_1.TaskComment])],
        exports: [task_comment_service_1.TaskCommentService],
    })
], TaskCommentModule);
